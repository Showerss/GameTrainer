...
from src.gametrainer.dependencies import ensure_dependencies, check_progress_bar_available
...
def main():
    ...
    try:
        ...
        print("  [OK] C++ input extension loaded successfully")
    except ImportError:
    ...
    for path in model_paths:
        if os.path.exists(path):
            ...
            print(f"  [OK] Model loaded successfully! Resuming from checkpoint.")
            break
